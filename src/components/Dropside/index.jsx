...
Dropside.TitleContainer = function DropsideTitleContainer({
  children,
  ...props
}) {
...
Dropside.PictureContainer = function DropsidePictureContainer({
  children,
  ...props
}) {
...
Dropside.MessagesContainer = function DropsideMessagesContainer({
  children,
  ...props
}) {
